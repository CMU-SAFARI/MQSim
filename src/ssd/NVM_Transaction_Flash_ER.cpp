...
namespace SSD_Components
{
	...
	NVM_Transaction_Flash_ER::NVM_Transaction_Flash_ER(Transaction_Source_Type source, stream_id_type streamID, 
		const NVM::FlashMemory::Physical_Page_Address& address, LPA_type lpa) :
		NVM_Transaction_Flash(source, Transaction_Type::ERASE, streamID, 0, lpa, NO_PPA, address, NULL, IO_Flow_Priority_Class::UNDEFINED)
	{
