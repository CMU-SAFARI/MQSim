...
#define All_VALID_PAGE 0x0000000000000000ULL
	...
	*/
	...
	public:
		...
		virtual void Allocate_block_and_page_in_plane_for_user_write_in_Zone(const stream_id_type streamID, NVM::FlashMemory::Physical_Page_Address& address) = 0; // for ZNS
