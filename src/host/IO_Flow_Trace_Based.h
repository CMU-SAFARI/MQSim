...
namespace Host_Components
{
	...
	{
	public:
		IO_Flow_Trace_Based(const sim_object_id_type& name, LHA_type start_lsa_on_device, LHA_type end_lsa_on_device, uint16_t io_queue_id,
		...
		void Get_statistics(Preconditioning::Workload_Statistics& stats, LPA_type(*Convert_host_logical_address_to_device_address)(LHA_type lha),
