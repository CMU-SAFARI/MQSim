...
string input_file_path, workload_file_path;

void command_line_args(char* argv[])
{
...
void read_parameters(string input_path, Execution_Parameter_Set* exec_params)
{
	...
	io_flow_1->Average_No_of_Reqs_in_Queue = 16;
...
int main(int argc, char* argv[])
{
	...
	read_parameters(input_file_path, exec_params);
