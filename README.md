...
1. **Contention Effect in the SSD Back END:** the 3 workload definition files in the *backend-contention* folder should be fed into MQSim as workload definition files. The input files and the corresponding output of execution are described below:<br />
...
The response time of flow-1 and flow-2 in the concurrent execution should be divided to the response time of flow-1 and flow-2, respectively, when they are executed alone.
